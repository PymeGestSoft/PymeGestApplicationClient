angular.module('tablesController', [
    'ngResource'
])
.factory('readClientes', [
    ...
    function($resource) {
        ...
        return $resource('http://pro2daw.pve.fpmislata.com/PymeGestApplicationServer/api/Usuario', {}, {
            query: {method: 'GET', isArray: true}
        });
    }])
.controller('clientesCtrl', ['$scope', 'readClientes', function($scope, readClientes) {
